...
public class ColorLabelTagHelper : TagHelper
{
    ...
    {
        output.TagName = "ColorLabel";
        var colorStyle = $"color:{Color}";
        output.Attributes.SetAttribute("style", colorStyle);
        output.PreContent.SetHtmlContent("<div class='border border-primary mt-2 ps-2 pe-2 bg-primary text-center bg-opacity-25 fw-bolder'>");
